...
/// {@endtemplate}
class RotadeTheme extends PuzzleTheme {
  /// {@macro simple_theme}
  const RotadeTheme() : super();

  @override
  String get name => 'Rotade';
  ...
  @override
  PuzzleLayoutDelegate get layoutDelegate => const RotadePuzzleLayoutDelegate();
